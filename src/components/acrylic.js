...
const HTML = /* html */`
<div class="layer fallback"></div>
<div class="layer luminosityBlend"></div>
<div class="layer mixColor"></div>
<div class="layer gaussianBlur"></div>
                ...
                set: overload()
                    .add([String], value => {
                        this.lock("tintColor", () => {
                            ...
                            this.#mixColorEl.style.backgroundColor = themeManager.enhanceToHDR(value);
                        });
                    })
                ...
                set: overload()
                    .add([String], value => {
                        this.lock("fallbackColor", () => {
                            ...
                            this.#fallbackEl.style.backgroundColor = themeManager.enhanceToHDR(value);
                        });
                    })
